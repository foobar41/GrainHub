...
class signupForm {
    constructor(fname, lname, email, num, add, pass, conf_pass, user) {
        this.fname = fname
        this.lname = lname
        this.email = email
        this.num = num
...
app.post('/signup', function (req, res) {
    ...
    const data = new signupForm(fname, lname, email, num, add, pass, conf_pass, user)
...
app.post('/login', function (req, res) {
    ...
    const data = new loginForm(email, pass, user)
...
class farmDetails {
    constructor(fname, lname, email, num, add, jowar, rice, corn, wheat) {
        this.fname = fname
        this.lname = lname
        this.email = email
        this.num = num
    ...
    farmer.findOne({ "email": cur_email }, function (err, result) {
        if (result) {
            ...
            users.findOne({ "email": cur_email }, function (err, result) {
                ...
                //     "wheat": 0
                // }
                const data = new farmDetails(result.fname, result.lname, cur_email, result.num, result.add, jowar, 0, 0, 0)
    ...
    farmer.findOne({ "email": cur_email }, function (err, result) {
        if (result) {
            ...
            users.findOne({ "email": cur_email }, function (err, result) {
                ...
                //     "wheat": 0
                // }
                const data = new farmDetails(result.fname, result.lname, cur_email, result.num, result.add, 0, rice, 0, 0)
                farmer.insertOne(data, function (err, collection) {
                    if (err) throw err;
                    console.log("Record inserted Successfully");
                });
    ...
    farmer.findOne({ "email": cur_email }, function (err, result) {
        if (result) {
            ...
            users.findOne({ "email": cur_email }, function (err, result) {
                ...
                //     "wheat": 0
                // }
                const data = new farmDetails(result.fname, result.lname, cur_email, result.num, result.add, 0, 0, corn, 0)
                farmer.insertOne(data, function (err, collection) {
                    if (err) throw err;
                    console.log("Record inserted Successfully");
                });
    ...
    farmer.findOne({ "email": cur_email }, function (err, result) {
        if (result) {
            ...
            users.findOne({ "email": cur_email }, function (err, result) {
                ...
                //     "wheat": wheat
                // }
                const data = new farmDetails(result.fname, result.lname, cur_email, result.num, result.add, 0, 0, 0, wheat)
                farmer.insertOne(data, function (err, collection) {
                    if (err) throw err;
                    console.log("Record inserted Successfully");
                });
...
class contactForm {
    constructor(fname, lname, email, num, msg) {
        this.fname = fname
        this.lname = lname
        this.email = email
        this.num = num
...
app.post('/contactSubmit', function (req, res) {
    ...
    const data = new contactForm(fname, lname, email, num, msg)
